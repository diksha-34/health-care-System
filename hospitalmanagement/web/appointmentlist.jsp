   ...
   <section class="w3l-contact py-5" id="contact" >
    ...
    <div class="input-grids">
        <div class="row justify-content-center">
            <form method="get">
               <div class="form-group">
                   <label for="datepicker" class="col-form-label"><h2>Select Doctor</h2></label>
                    <select  name="doctor" required="" class="form-control" id="dec">
                       <option value="">Select Doctor</option>
                        ...
                        try {
                            ...
                            PreparedStatement mystatement = myConnection.prepareStatement("SELECT distinct(doctor1) FROM appointment");
                            ResultSet myresult = mystatement.executeQuery();

                            while (myresult.next()) {
                                out.print("<option>" + myresult.getString("doctor1") + "</option>");
                            }
                        } catch (Exception e) {
