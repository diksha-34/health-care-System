        ...
        <div class="row justify-content-center">
            <form method="get">
               <div class="form-group">
	            ...
	            <select  name="medical" required="" class="form-control" id="med">
                       <option value="">Select Medical issue</option>
                        ...
                        try {
                            ...
                            PreparedStatement mystatement = myConnection.prepareStatement("SELECT distinct(issue) FROM medical");
                            ResultSet myresult = mystatement.executeQuery();

                            while (myresult.next()) {
                                out.print("<option>" + myresult.getString("issue") + "</option>");
                            }
                        } catch (Exception e) {
...
<div class="container"> 
  ...
  <script type="text/javascript">
    $(document).ready(function () {
        $("#med").change(function () {
            var medical1 = $(this).val();
            $.ajax({
                method: "POST",
                url: "myajax.jsp",
                data: { medical: medical1 }
            }).done(function (msg) {
                $("#resultbox").html(msg);
            });
        });
