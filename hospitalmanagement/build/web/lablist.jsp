   ...
   <section class="w3l-contact py-5" id="contact" >
    ...
    <div class="input-grids">
        <div class="row justify-content-center">
            <form method="get">
               <div class="form-group">
                   <label for="datepicker" class="col-form-label"><h2>Select Sample </h2></label>
                    <select  name="doctor" required="" class="form-control" id="samp">
                       <option value="">Select Sample Details </option>
                        ...
                        try {
                            ...
                            PreparedStatement mystatement = myConnection.prepareStatement("SELECT distinct(sample) FROM lab");
                            ResultSet myresult = mystatement.executeQuery();

                            while (myresult.next()) {
                                out.print("<option>" + myresult.getString("sample") + "</option>");
                            }
                        } catch (Exception e) {
